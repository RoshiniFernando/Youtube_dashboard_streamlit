...
# Create dataframes from the function load_data()
...
metric_date_12mo = df_agg_diff['Video publish time'].max() - pd.DateOffset(months =12) # Take only last 12 months
...
if add_sidebar == 'Aggregate Metrics':
    st.write("Ken Jee's YouTube Aggregated Data")
...
if add_sidebar == 'Individual Video Analysis':
    ...
    st.write("Ken Jee's YouTube Individual Video Performance")
